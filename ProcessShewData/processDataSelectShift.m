...
if (ischar(whichDatS))
    ...
    if(whichDatS==0)
        % AKB: I changed these to relative file locations
        infile = '../experimental_data/data012516_exp1+2';
        dSumm='../experimental_data/rat012506_1+2_summary.xlsx';
        %infile = '~/Dropbox/1_olfactory/experimental_data/data012516_exp1+2';
        %dSumm='~/Dropbox/1_olfactory/experimental_data/rat012506_1+2_summary.xlsx';
    elseif (whichDatS==1)
